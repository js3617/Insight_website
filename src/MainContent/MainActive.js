...
// 수정필요
import React, { useState } from 'react';
import './Mainstyle.css'; // CSS 파일 경로에 맞게 수정

const messages = {
  startup: "Startup Department Message",
  game: "Game Department Message",
  robot: "Robot Department Message",
  web: "Web Department Message"
};

function Active() {
  const [activeDepartment, setActiveDepartment] = useState('startup');
